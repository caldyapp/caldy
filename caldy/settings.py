"""
Django settings for caldy project.
...
SECRET_KEY = "django-insecure-^h6mj8dkxg@#(9h_cog3#euefz(5ti_ppdteunfu8ej7s-hq+t"
...
WSGI_APPLICATION = "caldy.wsgi.application"
